...
try {
    ...
    case 'pages':
      ...
      switch ($_GET['sub_view']) {
        ...
        case 'edit_page':
          ...
          /* get countries */
          $data['countries'] = $user->get_countries();
          /* get custom fields */
  ...
  if ($user->_is_admin) {
    ...
    $get_funding_payments = $db->query("SELECT COUNT(*) as count FROM funding_payments WHERE status = '0'") or _error("SQL_ERROR");
    ...
    $get_monetization_payments = $db->query("SELECT COUNT(*) as count FROM monetization_payments WHERE status = '0'") or _error("SQL_ERROR");
