...
try {
 ...
 $_POST['order_field'] = (isset($_POST['order_field'])) ? $_POST['order_field'] : '10';
  ...
  switch ($_GET['do']) {
    ...
    case 'add':
      /* insert */
      $sql = sprintf("INSERT INTO user_group (`group_name`, `create_post`, `create_articles`, `share_post`, `comments`, `likes`, `star_rate`, `create_page`, `manager_page`, `add_friend`, `follow_page`, `follow_writer`, `manage_user`, `create_user_group`, `change_logo`, `control_panel_setting`, `approves_type`, `add_jobs`, `manage_support`, `description`, `order_field`) VALUES (%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s)",
