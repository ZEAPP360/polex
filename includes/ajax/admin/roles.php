  ...
  switch ($_GET['do']) {
    ...
    case 'add':
      ...
      $sql = sprintf("INSERT INTO user_group (
        `group_name`, `create_post`, `create_articles`, `edit_article`, `view_article`, `delete_article`, `approve_article`, `share_post`, `add_comment`, `edit_comment`, `likes`, `star_rate`, `create_page`, `manager_page`, `add_friend`, `follow_page`, `follow_writer`, `manage_user`, `create_user_group`, `change_logo`, `control_panel_setting`, `approves_type`, `add_jobs`, `manage_support`, `approves_category`, `disable_social_media`, `manage_reported_content`, `invite_researchers`, `can_add_tags`, `description`, `order_field`) VALUES (%s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
