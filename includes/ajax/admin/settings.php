  ...
  switch ($_GET['edit']) {
    ...
    case 'features':
      ...
      update_system_options([
        ...
        'gifts_permission' => secure($_POST['gifts_permission']),
    ...
    case 'posts':
      ...
      update_system_options([
        ...
        'colored_posts_permission' => secure($_POST['colored_posts_permission']),
        'activity_posts_enabled' => secure($_POST['activity_posts_enabled']),
        'activity_posts_permission' => secure($_POST['activity_posts_permission']),
        ...
        'polls_posts_permission' => secure($_POST['polls_posts_permission']),
        'geolocation_enabled' => secure($_POST['geolocation_enabled']),
        'geolocation_posts_permission' => secure($_POST['geolocation_posts_permission']),
        'geolocation_key' => secure($_POST['geolocation_key']),
        'gif_enabled' => secure($_POST['gif_enabled']),
        'gif_posts_permission' => secure($_POST['gif_posts_permission']),
        ...
        'anonymous_posts_permission' => secure($_POST['anonymous_posts_permission']),
    ...
    case 'uploads':
      ...
      update_system_options([
        ...
        'videos_upload_permission' => secure($_POST['videos_upload_permission']),
        ...
        'audios_upload_permission' => secure($_POST['audios_upload_permission']),
        ...
        'files_upload_permission' => secure($_POST['files_upload_permission'])
      ]);
      break;
