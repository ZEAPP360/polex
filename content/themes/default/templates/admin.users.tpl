                ...
                <div class="form-group col-md-6">
                  ...
                  <select class="form-control" name="user_gender">
                    ...
                    {foreach $genders as $gender}
                      <option {if $data['user_gender'] == $gender['gender_id']}selected{/if} value="{$gender['gender_id']}">{__($gender['gender_name'])}</option>
                    {/foreach}
                  </select>
                </div>
              ...
              {if $data['can_monetize_content']}
                <div class="pl-md-4">
                  ...
                  <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control" name="user_monetization_price" value="{$data['user_monetization_price']}">
                      <span class="form-text">
