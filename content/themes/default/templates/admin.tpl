            ...
            {if $user->_is_admin}
                  ...
                  <ul>
                    ...
                    <li {if $view == "settings" && $sub_view == "accounts"}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/settings/accounts">
                        <i class="fa fa-users-cog fa-fw mr10"></i>{__("Accounts Settings")}
                      </a>
                    </li>
              ...
              <li {if $view == "countries"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/countries">
                  <i class="fa fa-globe fa-fw mr10" style="color: #3F51B5"></i>{__("Countries")}
                </a>
              </li>
              <!-- Countries -->
              ...
              <li {if $view == "genders"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/genders">
                  <i class="fa fa-venus-mars fa-fw mr10" style="color: #3F51B5"></i>{__("Genders")}
                </a>
              </li>
              <!-- Genders -->
            {/if}
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <li {if $view == "wallet"}class="active" {/if}>
                <a href="#wallet" data-toggle="collapse" {if $view == "wallet"}aria-expanded="true" {/if}>
                  ...
                  <ul>
                    ...
                    <li {if $view == "wallet" && $sub_view == "payments"}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/wallet/payments">
                        {if $wallet_payments_insights}<span class="float-right badge badge-pill badge-danger">{$wallet_payments_insights}</span>{/if}
                        {__("Payment Requests")}
                      </a>
                    </li>
                  </ul>
              ...
              <li {if $view == "pro"}class="active" {/if}>
                <a href="#pro" data-toggle="collapse" {if $view == "pro"}aria-expanded="true" {/if}>
                  <i class="fa fa-cubes fa-fw mr10" style="color: #4CAF50"></i>{__("Pro System")}
                </a>
              ...
              <li {if $view == "funding"}class="active" {/if}>
                <a href="#funding" data-toggle="collapse" {if $view == "funding"}aria-expanded="true" {/if}>
                  ...
                  <ul>
                    ...
                    <li {if $view == "funding" && $sub_view == "payments"}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/funding/payments">
                        {if $funding_payments_insights}<span class="float-right badge badge-pill badge-danger">{$funding_payments_insights}</span>{/if}
                        {__("Payment Requests")}
                      </a>
                    </li>
              ...
              <li {if $view == "monetization"}class="active" {/if}>
                <a href="#monetization" data-toggle="collapse" {if $view == "monetization"}aria-expanded="true" {/if}>
                  <i class="fa fa-comment-dollar fa-fw mr10" style="color: #4CAF50"></i>{__("Content Monetization")}
                </a>
                  ...
                  <ul>
                    ...
                    <li {if $view == "monetization" && $sub_view == "payments"}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/monetization/payments">
                        {if $monetization_payments_insights}<span class="float-right badge badge-pill badge-danger">{$monetization_payments_insights}</span>{/if}
                        {__("Payment Requests")}
                      </a>
                    </li>
                  </ul>
        ...
        <div class="card-body with-nav">
          <ul class="side-nav">
            ...
            <li {if $view == "reports"}class="active" {/if}>
              <a href="#reports" data-toggle="collapse" {if $view == "reports"}aria-expanded="true" {/if}>
            ...
            <ul class="side-nav">
              ...
              <li {if $view == "reactions"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/reactions">
                  <i class="fa fa-smile fa-fw mr10" style="color: #FF5722"></i>{__("Reactions")}
                </a>
              </li>
              <!-- Reactions -->
              ...
              <li {if $view == "emojis"}class="active" {/if}>
                <a href="{$system['system_url']}/{$control_panel['url']}/emojis">
                  <i class="fa fa-grin-tears fa-fw mr10" style="color: #FF5722"></i>{__("Emojis")}
                </a>
              </li>
              <!-- Emojis -->
